...
We interpret the above tables as follows.  On a randomly selected walk the mean walking distance is `r predictions$forcast[4]` miles.  There is a 95% probability that the walk will be between `r predictions$lower` and `r predictions$upper` miles.  This may seem like a wide interval.  
