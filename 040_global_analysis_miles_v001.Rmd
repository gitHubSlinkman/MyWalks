...
We interpret the above tables as follows.  On a randomly selected walk the mean walking distance is `r predictions$Forcast[4]` miles.  There is a 95% probability that the walk will be between 2.06 and 5.25 miles.  This may seem like a wide interval.  
