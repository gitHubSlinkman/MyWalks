---
title: 'Test: compute_minimums_v01.Rmd'
...
compute_minimums( last_007_day_routes ) %>% 
    flextable()
```
...
compute_minimums( last_030_day_routes ) %>% 
    flextable()
```

### Last_180_day_routes
```{r test_last_180_days_routes}
compute_minimums( last_180_day_routes ) %>% 
    flextable()
```
  
### Last_year_day_routes
```{r test_last_year_days_routes}
compute_minimums( last_year_day_routes ) %>% 
    flextable()
```
