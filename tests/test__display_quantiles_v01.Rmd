---
title: 'Test:display_quantiles_v01.Rmd'
...
source('D:/R-Projects/MyWalks/functions/compute_quantiles_v01.R')
 source('D:/R-Projects/MyWalks/functions/display_quantiles_v01.R')
```
...
quantiles <- compute_quantiles( last_030_day_routes ) 
display_quantiles( quantiles )
...
display_quantiles( compute_quantiles( last_180_day_routes ) )
```
```
  
### Last_year_day_routes
```{r test_last_year_days_routes}
display_quantiles( compute_quantiles( last_year_day_routes ))
```
