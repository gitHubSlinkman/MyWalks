---
title: 'Test: compute_q25_v01.Rmd'
...
compute_q25( last_007_day_routes ) %>% 
    flextable()
```
...
compute_q25( last_030_day_routes ) %>% 
    flextable()
```

### Last_180_day_routes
```{r test_last_180_days_routes}
compute_q25( last_180_day_routes ) %>% 
    flextable()
```
  
### Last_year_day_routes
```{r test_last_year_days_routes}
compute_q25( last_year_day_routes ) %>% 
    flextable()
```
