---
title: 'Test: computemedians_v01.Rmd'
...
compute_medians( last_007_day_routes ) %>% 
    flextable()
```
...
compute_medians( last_030_day_routes ) %>% 
    flextable()
```

### Last_180_day_routes
```{r test_last_180_days_routes}
compute_medians( last_180_day_routes ) %>% 
    flextable()
```
  
### Last_year_day_routes
```{r test_last_year_days_routes}
compute_medians( last_year_day_routes ) %>% 
    flextable()
```
