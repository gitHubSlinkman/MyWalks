...
## Univariate analysis for `r VLABEL` walked
...
If the bootstraped means and standard errors are normally idstributed then they be uncorrelated.  We compute the correlation matrix to investicate if the correlation between the means and standard deviations are ubcorreleated.
...
```{r bootstrap_prediction intervals}
#
compute_prediction <- function( y, 
                                index, 
                                alpha=0.05 ){
    y <- y[index]
    n <- length( y )
