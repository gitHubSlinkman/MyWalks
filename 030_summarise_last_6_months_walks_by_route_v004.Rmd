...
```{r load libraries}
#
source( "functions/load_libraries_v002.R" )      # L0ad libraries ...
#
```
...
```{r load_functions}
#
source( 'functions/load_libraries_v002.R' )      # To load libraries ...
source( "functions/compute_dates_v003.R" )       # To compute dates 
source( "functions/get_walks_v004.R")            # Used to read walks.xlsx file ...
#       
```
